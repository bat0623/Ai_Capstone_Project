			...
			{
				{
					...
					-- Flaaaameeaaaterrrr!
					{ Cue = "/VO/ZagreusField_3186", ChanceToPlay = 1.0, PlayOnce = true, RequiredPlayed = { "/VO/ZagreusField_3181" } },
				},
				{
					BreakIfPlayed = true,
					RandomRemaining = true,
					...
					-- Flaaaameeaaaterrrr!
					{ Cue = "/VO/ZagreusField_3186", RequiredPlayed = { "/VO/ZagreusField_3181" } },
				},
				[2] = GlobalVoiceLines.FishIdentifiedVoiceLines,
			},
