    ...
    def __format_conversation(self, player_info, npc_info, situation_name):
        ...
        for question in question_list:
            for answer in answer_list:
                ...
                instruction = "배경: {n_era}  도시: {n_city}    플레이어: {p_name}({p_job}, {p_social_status})  NPC: {n_name}({n_job}, {n_social_status}, {n_social_status}관계))"
        ...
        for player in player_dict:
            ...
            for npc in npc_dict:
                ...
                for conv in conv_jsonl_gen:
                    print(json.dumps(conv, ensure_ascii=False, indent=4))
